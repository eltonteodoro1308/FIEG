...
@param cNumPC, Caractere, Número do Pedido de Compra.
@param cItemPC, Caractere, Item do Pedido de Compra.
@param cDtEntrega, Caractere, Data de Entrega do Pedido de Compra.
