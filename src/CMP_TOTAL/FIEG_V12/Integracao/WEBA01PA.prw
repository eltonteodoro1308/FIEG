...
Função que lê o array com a descrição do erro ocorrido na execução do ExecAuto e monta e retorna uma string com este erro.
...
@history 13/05/2019, elton.alves@TOTVS.com.br, Função adicionada para substituir a função MostraErro que mostra o erro visualmente e não retorna mais o erro em caracteres.

@return Caractere, Erro ocorrido na execução do ExecAuto.
...
Static Function GetError()
	...
	Local cRet  := ''
	Local aErro := aClone( GetAutoGRLog() )
